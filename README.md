...
* [__Part A__:](CNN-train.ipynb) Analyze and compare GoogLeNet, MobileNet V3, and NasNet architectures, then apply transfer learning.
* [__Part B__:](Fine-tune.ipynb) Fine-tune the best-performing model from Part A and analyze the improvements.
## 📁 Dataset Description
